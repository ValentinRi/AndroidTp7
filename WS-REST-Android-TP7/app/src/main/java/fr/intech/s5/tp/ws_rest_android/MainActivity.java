...
import fr.intech.s5.tp.ws_rest_android.fr.intech.s5.tp.ws_rest_android.utils.NetworkHelper;
import fr.intech.s5.tp.ws_rest_android.fr.intech.s5.tp.ws_rest_android.utils.RequestPackage;
...
public class MainActivity extends AppCompatActivity {
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        DataItem[] dataItems = (DataItem[]) intent.getParcelableArrayExtra(MyIntentService.MY_INTENT_SERVICE_MESSAGE);
            ...
            Toast.makeText(MainActivity.this, "Reception de " + dataItems.length + "items delivrés par le service", Toast.LENGTH_SHORT).show();
